...
class TestJsonSearch:
    ...
    def test_returns_dict(self, library) -> None:
    ...
    def test_returns_list(self, library) -> None:
    ...
    def test_returns_string(self, library) -> None:
    ...
    def test_returns_number(self, library) -> None:
    ...
    def test_returns_none_for_no_match(self, library) -> None:
        """Test that None is returned for no match."""
        data = {"name": "Alice"}
        result = library.json_search(data, "missing")
        assert result is None

    def test_jmespath_function(self, library) -> None:
