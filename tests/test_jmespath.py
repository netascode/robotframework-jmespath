...
class TestJsonSearch:
    ...
    @pytest.fixture
    def library(self) -> JMESPath:
        """Create JMESPath library instance."""
        return JMESPath()

    def test_returns_dict(self, library: JMESPath) -> None:
    ...
    def test_returns_list(self, library: JMESPath) -> None:
    ...
    def test_returns_string(self, library: JMESPath) -> None:
    ...
    def test_returns_number(self, library: JMESPath) -> None:
    ...
    def test_returns_none_for_no_match(self, library: JMESPath) -> None:
        """Test that None is returned for no match."""
        data = {"name": "Alice"}
        result = library.json_search(data, "missing")
        assert result is None

    def test_jmespath_function(self, library: JMESPath) -> None:
