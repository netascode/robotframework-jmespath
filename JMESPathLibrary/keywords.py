...
class JMESPathKeywords:
    ...
    def json_search_string(self, data: Any, expression: str) -> str:
        ...
        <table border="1">
            <tr>
                <td>${result}=</td>
                <td>JSON Search String</td>
                <td>${json}</td>
                <td>imdata&#91;0&#93;.fvTenant.attributes.name</td>
            </tr>
            <tr>
                <td>${result}=</td>
                <td>JSON Search String</td>
                <td>${json}</td>
                <td>imdata&#91;0&#93;.fvTenant.children&#91;?fvAp&#93; | &#91;0&#93;.fvAp.attributes.name</td>
            </tr>
        </table>
        """
    ...
    def json_search_list(self, data: Any, expression: str) -> list[Any]:
        ...
        <table border="1">
            <tr>
                <td>${results}=</td>
                <td>JSON Search List</td>
                <td>${json}</td>
                <td>imdata&#91;0&#93;.fvTenant.children&#91;*&#93;.fvAp.attributes.name</td>
            </tr>
            <tr>
                <td>${ips}=</td>
                <td>JSON Search List</td>
                <td>${json}</td>
                <td>imdata&#91;0&#93;.fvBD.children&#91;*&#93;.fvSubnet.attributes.ip</td>
            </tr>
        </table>
        """
        result = self.json_search(data, expression)
